...
INSERT INTO "new_car" ("brandId", "createAt", "fueltype", "hasTowBar", "id", "isActive", "model", "price", "year") SELECT "brandId", "createAt", "fueltype", "hasTowBar", "id", "isActive", "model", "price", "year" FROM "car";
DROP TABLE "car";
